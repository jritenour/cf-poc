...
RestClient.get "http://slack.com/api/chat.postMessage?token=#{token}&channel=#{channel}&text=Request ID #{miq_request.id} has been approved by Administrator because #{miq_request.reason}"
